...
// Is just to remove the last item - Mutable because it removes it
...
const indexOfAvocado = toppings.indexOf('Avocado');
...
// add it if it's not
if (!isInToppings) toppings.push('Hot Sauce');
console.log(toppings);

// flip those toppings around with reverse()
// toppings.reverse();
// console.log(toppings); // MUTABLE
...
function sortCallback(firstItemSort, secondItemSort) {
  return firstItemSort - secondItemSort;
}

const numbersSorted = numbers.sort(sortCallback);
